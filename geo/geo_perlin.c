...
/*   Updated: 2016/08/26 03:59:57 by snicolet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static float		noise(t_v2f n)
{
	...
	sn = geo_smoothstep((t_v2f){0.0f, 0.0f}, (t_v2f){1.0f, 1.0f},
		geo_fract_v2f(n));
    h1 = geo_mix(r(fn), r(geo_addv2f((t_v2f){fn.x, fn.y}, (t_v2f){1.0f, 0.0f})),
		sn.x);
